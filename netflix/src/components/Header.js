...
const Header = () => {
  ...
  return (
    <div className='absolute z-10 bg-gradient-to-b from-black to-transparent bg-opacity-10 w-full justify-between flex items-center' >
        <div className=' p-12'>
            <svg viewBox="0 0 111 30" className='h-12 ' aria-hidden="true" focusable="false">
